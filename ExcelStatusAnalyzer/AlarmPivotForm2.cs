...
namespace ExcelStatusAnalyzer
{
    public partial class AlarmPivotForm2 : Form
    {
        ...
        // 그룹별 리스트 (APAMA: KTCB-01~04, APTURA: KTCB-05~09)
        ...
        public AlarmPivotForm2()
        {
            ...
            _apturaList = LoadWhitelistFromTxt("APTURA_ALID"); // KTCB-05~09

            // 시트 인덱스 기준으로 매핑 (1:KTCB-01, 2:KTCB-02, 3:KTCB-03, 4:KTCB-04, 5:KTCB-05, 6:KTCB-06, 7:KTCB-07, 8:KTCB-08, 9:KTCB-09)
            if (_apamaList != null)
            {
        ...
        {
            Text = "Alarm Name × 날짜별 발생횟수 (KTCB-장비별)";
            Width = 1200;
            Height = 800;
